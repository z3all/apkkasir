...
if (isset($_POST['id_pelanggan'])) {
    ...
    if ($query) {
        echo '<script>alert("Tambah Data berhasil disimpan"); location.href="?page=pembelian"</script>';
    } else {
        echo '<script>alert("Tambah Data gagal disimpan"); location.href="?page=pembelian"</script>';
    }
}
