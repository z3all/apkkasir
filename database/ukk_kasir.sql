...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2025 at 01:30 AM
...
(6, 'rahadian', 'ponokawan', '0897654231');
...
(8, '2025-01-13', 200000.00, 6),
(9, '2025-01-13', 1000000.00, 6);
...
(3, 'zeilla', 'zeall', '38ef0fbf02fa13566d0633e5621a90bc', 'admin'),
(4, 'q', 'aaaa', '81dc9bdb52d04dc20036dbd8313ed055', 'admin');
...
--
ALTER TABLE `detailpenjualan`
  ADD CONSTRAINT `detailpenjualan_ibfk_1` FOREIGN KEY (`id_penjualan`) REFERENCES `penjualan` (`id_penjualan`) ON DELETE CASCADE,
  ADD CONSTRAINT `detailpenjualan_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`);
